...
const services = [
  {
    ...
    description: "Weby na míru, které přivádějí zákazníky a zvyšují tržby — ne jen návštěvníky. Každý pixel ručně, každý detail pro váš byznys.",
  ...
  },
  {
    ...
    description: "Tvorba grafiky na míru — logo, vizitky, šablony, PDF materiály. Vizuální identita, která se nezapomíná a zvyšuje důvěru zákazníků.",
    badge: "Nejžádanější",
