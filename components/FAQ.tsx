...
const faqs = [
  ...
  { question: "Pracuješ s AI nebo je vše ručně?", answer: "Vše dělám ručně. Žádný AI generátor kódu, žádné šablony. Každý web je originál vytvořený přesně pro vás a váš byznys." },
